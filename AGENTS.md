...
This project is indexed by GitNexus as **manga-image-translator** (6987 symbols, 13837 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
